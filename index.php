...
class website { /** * Liste des classes metier et classes du framework * @var array */
    ...
    /**     * Inclut toutes les classes du dossier "class" se finissant par ".class.php" <br /> * Vous pouvez créer vos propres classes avec cette extension pour les charger automatiquement avant de les utiliser dans votre application */
